...
INSERT INTO coding_systems (system_code, system_name, system_uri, system_type, owner) VALUES
    ...
    ('WHONET_FAC',  'WHONET Facility Codes',                           NULL,                                  'external', 'WHO Collaborating Centre'),
    ('WHONET_TEST', 'WHONET Test Codes',                               NULL,                                  'external', 'WHO Collaborating Centre'),
    ('DEFAULT_ORG',  'Default Organism Codes',                         NULL,                                  'external', NULL),
    ('DEFAULT_ABX',  'Default Antibiotic Codes',                       NULL,                                  'external', NULL),
    ('DEFAULT_SPEC', 'Default Specimen Codes',                         NULL,                                  'external', NULL),
    ...
    ('HL7_FAC',  'HL7 Facility Codes',                         'http://terminology.hl7.org',                                  'external', 'HL7 International'),
    ('HL7_TEST', 'HL7 Test Codes',                             'http://terminology.hl7.org',                                  'external', 'HL7 International'),
    ('HL7_RESULT', 'HL7 Result Codes',                         'http://terminology.hl7.org',                                  'external', 'HL7 International'),
