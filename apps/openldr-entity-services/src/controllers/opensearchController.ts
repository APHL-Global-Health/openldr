...
router.get("/index-document-count", async function (req, res) {
  try {
...
router.get("/interval-message-count", async function (req, res) {
  try {
    // const { startDateTime, endDateTime } = req.query;
    // if (!startDateTime || !endDateTime) {
    //   return res.status(400).json({
...
router.get("/get-latest-messages", async function (req, res) {
  try {
    // const { startDateTime, endDateTime } = req.query;
    // if (!startDateTime || !endDateTime) {
    //   return res.status(400).json({
