...
if (
  !process.env.VALIDATION_MINIO_ACCESS_KEY ||
  !process.env.VALIDATION_MINIO_SECRET_KEY
) {
...
const minioClient = new Minio.Client({
  ...
  port: 9000,
  accessKey: process.env.VALIDATION_MINIO_ACCESS_KEY,
  secretKey: process.env.VALIDATION_MINIO_SECRET_KEY,
  useSSL: false,
});
...
export { getObject, putObject, statObject };
