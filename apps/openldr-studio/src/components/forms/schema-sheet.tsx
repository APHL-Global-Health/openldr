...
const SchemaSheet = ({
  ...
  return (
    ...
    >
      <SheetContent
        side="right"
        className="flex flex-col min-w-lg p-0 pt-2 gap-0 "
      ...
      >
        ...
        <div className="flex flex-row gap-2 w-full px-3 py-2">
        ...
        <Separator className="mt-1 mb-1 border" />
        <div className="flex w-full px-3 text-sm">
        ...
        <div className="grid grid-cols-[auto_1fr_1fr_auto_auto] gap-0 gap-y-4 w-full">
          <div className="flex w-8 items-center pl-4 h-8 col-start-1 text-sm">
            <KeyRound className="h-3.25 w-3.25" />
          </div>
          ...
          <div className="flex w-24 items-center p-0  pl-3 h-8 col-start-4 text-[10px] cursor-default">
            Constraint
          </div>
                ...
                <Fragment key={`${column.id}_${index}`}>
                  ...
                  >
                    ...
                    >
                      ...
                      <SelectContent
                        align="start"
                        className="max-h-64 rounded-xs border bg-dash-sidebar"
                      >
                        <SelectGroup>
                          {dataTypes.map((type) => (
                  ...
                  <div
                    className={`flex w-24 items-center p-0  pl-2 h-8 col-start-4 row-start-${index + 1}`}
                  >
                    <input
                      type="text"
