...
export const Button: React.FC<ButtonProps> = ({
  ...
  const v = {
    primary:
      "bg-[#6EE7B7] text-[#0A1628] font-bold hover:bg-[#4ADE80] shadow-lg shadow-[#6EE7B7]/20",
    secondary:
      "bg-[#1A2C40] border border-[#2A3F57] text-[#A0B4C8] hover:border-[#4A6480] hover:text-[#E2EAF4]",
