...
function SettingsPage() {
  ...
  return (
    <ContentLayout nav={navComponents()}>
      ...
      >
        <div className="flex w-full h-full flex-row min-h-[calc(100vh-26px-56px)] max-h-[calc(100vh-26px-56px)]">
          <div className="flex flex-col min-w-48 max-w-48 h-full overflow-y-auto">
            {" "}
