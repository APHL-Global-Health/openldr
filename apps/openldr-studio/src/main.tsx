...
const ConceptsPage = React.lazy(() => import("@/pages/ConceptsPage"));
const PipelineRunsPage = React.lazy(() => import("@/pages/PipelineRunsPage"));
