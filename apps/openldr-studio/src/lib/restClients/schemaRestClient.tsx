...
export async function getAllTables(token: any, signal?: AbortSignal) {
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/archives/tables`,
      {
        method: "GET",
        headers: {
...
export async function getTableData(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/archives/data/${table}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export async function getTableColumns(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/archives/table/${table}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function manipulateData(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/archives/table/${version}/${table}/${type}`,
      {
        method,
        headers: {
          "Content-Type": "application/json",
