    ...
    data_feed: {
      ...
      schema_plugin: dataFeed.schemaPlugin
        ? {
            ...
            plugin_minio_object_path:
              dataFeed.schemaPlugin.pluginMinioObjectPath,
          }
        : null,
      mapper_plugin: dataFeed.mapperPlugin
        ? {
            ...
            plugin_minio_object_path:
              dataFeed.mapperPlugin.pluginMinioObjectPath,
          }
        : null,
      recipient_plugin: dataFeed.recipientPlugin
        ? {
            ...
            plugin_minio_object_path:
              dataFeed.recipientPlugin.pluginMinioObjectPath,
          }
        : null,
    },
    message: {
