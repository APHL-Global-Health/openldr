...
const DEFAULT_PLUGINS: SeedPlugin[] = [
  ...
  },
  {
    ...
    pluginType: "validation",
    pluginName: "hl7-fhir-schema",
    pluginVersion: "1.0.0",
    fileName: "hl7-fhir.schema.js",
    localRelativePath: "default-plugins/schema/hl7-fhir.schema.js",
    securityLevel: "high",
    notes: "Bundled HL7 v2x and FHIR validation plugin",
    status: "active",
  },
  // {
  ...
  //   securityLevel: "medium",
  //   notes:
  //     "Bundled generic lab XML validation plugin (application/xml, text/xml)",
  //   status: "active",
  // },
  // {
...
const runSqlInPostgres = (sql: string): void => {
  ...
  try {
    ...
    execSync(
      `docker cp "${tmpFile}" openldr-postgres:/tmp/openldr-plugin-seed.sql`,
    );
    execSync(
 ...
 *   storage    : 6f31845c-41f9-422c-a773-d5a37d7eae2e  (default-storage v1.2.0)
 *   outpost    : 83d52575-ecf6-4d86-aa8f-30480f883a5b  (default-outpost v1.2.0)
 */
...
VALUES (
  ...
  '6f31845c-41f9-422c-a773-d5a37d7eae2e',
