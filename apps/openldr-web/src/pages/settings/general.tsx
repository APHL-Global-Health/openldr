...
export function SettingsGeneral() {
  ...
  return (
    <div className="flex w-full h-full justify-center items-start overflow-y-auto py-8">
      <div className="flex flex-col space-y-10">
        <Card className="w-3xl h-auto rounded-sm">
          ...
          <CardContent className="flex flex-col py-2">
            <div className="grid grid-cols-2 py-2 space-y-2 w-full">
              <div className="flex items-center text-sm">API Base URL</div>
            ...
            <div className="grid grid-cols-2 py-2 space-y-2 w-full">
              <div className="flex items-center text-sm">Base URL</div>
              <InputGroup className="rounded-xs">
            ...
            <div className="grid grid-cols-2 py-2 space-y-2 w-full">
              <div className="flex items-center text-sm">Base Port</div>
              <InputGroup className="rounded-xs">
        ...
        <Card className="w-3xl h-auto rounded-sm">
          ...
          <CardContent className="flex flex-col py-2">
            <div className="grid grid-cols-2 py-2 space-y-2 w-full">
              <div className="flex items-center text-sm">APISIX URL</div>
              <InputGroup className="rounded-xs">
                <InputGroupInput
                  value={ENV.VITE_APISIX_DASHBOARD_URL}
                  readOnly
                />
                <InputGroupAddon align="inline-end">
                  <NavLink
                    to={ENV.VITE_APISIX_DASHBOARD_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className={cn(
                      buttonVariants({
                  ...
                  <InputGroupButton
                    ...
                    size="icon-xs"
                    onClick={() => {
                      copyToClipboard(ENV.VITE_APISIX_DASHBOARD_URL);
                    }}
                  >
                    {isCopied ? <CheckIcon /> : <CopyIcon />}
                  </InputGroupButton>
            ...
            <div className="grid grid-cols-2 py-2 space-y-2 w-full">
              <div className="flex items-center text-sm">Redis URL</div>
              <InputGroup className="rounded-xs">
                <InputGroupInput
                  value={ENV.VITE_REDIS_DASHBOARD_URL}
                  readOnly
                />
                <InputGroupAddon align="inline-end">
                  <NavLink
                    to={ENV.VITE_REDIS_DASHBOARD_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className={cn(
                      buttonVariants({
                  ...
                  <InputGroupButton
                    ...
                    size="icon-xs"
                    onClick={() => {
                      copyToClipboard(ENV.VITE_REDIS_DASHBOARD_URL);
                    }}
                  >
                    {isCopied ? <CheckIcon /> : <CopyIcon />}
                  </InputGroupButton>
