...
function DataEntryPage() {
  ...
  const allowed = [".zip", ".jsonl", ".sqlite", ".db", ".csv", ".tsv"];
        ...
        >
          {loading || isLoading || isRefetching ? (
            ...
            <div className="flex w-full flex-col">
              ...
              >
                <ItemMedia variant="icon" className="dark:bg-white text-black">
                  <NotebookIcon />
                </ItemMedia>
                <ItemContent>
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to import {importDialog.data.length} record
