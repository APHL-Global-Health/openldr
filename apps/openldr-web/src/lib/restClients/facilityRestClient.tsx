...
export async function createFacility(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/facility/create`,
      {
        method: "POST",
        headers: {
...
export async function getAllFacilities(token: any, signal?: AbortSignal) {
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/facility`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function updateFacility(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/facility/update/${facilityId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export async function deleteFacility(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/facility/delete/${facilityId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
