...
export async function createUseCase(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/usecase/create`,
      {
        method: "POST",
        headers: {
...
export async function getAllUseCases(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/usecase${query}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function updateUseCase(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/usecase/update/${useCaseId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export async function deleteUseCase(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/usecase/delete/${useCaseId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
