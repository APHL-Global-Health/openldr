...
export async function createUser(user: any, token: any, signal?: AbortSignal) {
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/user/create`,
      {
        method: "POST",
        headers: {
...
export async function getAllUsers(token: any, signal?: AbortSignal) {
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/user`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function updateUser(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/user/update/${userId}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export async function deleteUser(
  ...
  try {
    const response = await fetch(
      `${ENV.VITE_API_BASE_URL}/api/v1/openldr/user/delete/${userId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
