  ...
  return (
    <div className="w-full">
      ...
      <Sheet open={isSheetOpen} onOpenChange={setSheetOpen}>
        <SheetContent>
          <SheetHeader className="border-b-1 pb-0">
            <SheetTitle>{title}</SheetTitle>
            <SheetDescription></SheetDescription>
          </SheetHeader>
          <div className="flex w-[100%] items-center px-2 py-0 my-0">
            <InputGroup className="rounded-[2px]">
          ...
          <div className="flex items-center justify-between px-0 text-foreground-default border-t">
            <div className="flex items-center space-x-6 lg:space-x-8">
              <div className="flex items-center space-x-2">
                ...
                >
                  <SelectTrigger className="h-8 w-[90px] rounded-[0px]">
                    <SelectValue
              ...
              <div className="flex w-[100px] items-center justify-center text-xs font-medium cursor-default">
              ...
              <div className="flex items-center">
                <Button
                  variant="outline"
                  className="hidden h-8 w-8 p-0 lg:flex rounded-[0px]"
                ...
                <Button
                  variant="outline"
                  className="h-8 w-8 p-0 rounded-[0px]"
