    ...
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      <PopoverTrigger asChild>
        {renderTrigger ? (
          ...
          <div
            className={cn(
              "flex w-full cursor-pointer items-center h-9 ps-2 pe-1 font-normal  b-0 border-none text-sm shadow-sm",
...
function TimePicker({
  ...
  const onHourChange = useCallback(
    ...
    [setHour, use12HourFormat, value, formatStr, minute, second, ampm, max, min]
  );
